...
const NewListingForm = setShowNewListingModal => {
  ...
  const styles = {
    wrapper: `mt-2 text-white`,
    formWrapper: `grid grid-cols-1 gap-3 text-white`,
    formInputContainer: `flex flex-col border rounded-lg px-3 py-2 text-white`,
    inputLabel: `text-xs font-light text-white`,
    input: `outline-none bg-white text-black text-sm pt-1`,
  }
    ...
    <div className={styles.wrapper}>
      ...
      <div className='mt-4 flex justify-end'>
        <button
          ...
          type='button'
          className='border rounded-lg px-4 py-2 text-sm font-medium bg-black text-purple-500'
        >
          Create
        </button>
      </div>
