      ...
      <Dialog as='div' className='relative z-50' onClose={closeModal}>
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <Dialog.Panel className='w-full max-w-fit transform overflow-hidden rounded-2xl bg-black text-black p-6 text-left align-middle shadow-xl transition-all'>
                <Dialog.Title
                  as='h3'
                  className='text-lg font-medium leading-6 text-purple-500'
                >
                  Reserve Property
                </Dialog.Title>
                ...
                <div className='mt-2'>
                  ...
                  <div className='mt-4 flex justify-end'>
                    <button
                      onClick={onConfirm}
                      type='button'
                      className='border rounded-lg px-4 py-2 text-purple-500 text-sm font-medium'
                    >
                      Confirm
                    </button>
                  </div>
